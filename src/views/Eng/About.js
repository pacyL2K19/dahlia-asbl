...
const AboutE = () => {
    ...
    return (
        <div>
            ...
            <h3 style={{textAlign:'center', fontWeight : 'bold', fontSize : 45, marginTop : 30, marginBottom : 20, color : '#733b83'}}>Our Vision & Our Goals</h3><br />
            <div id = 'mainContent' className = 'container'>
                <Grid container>
                    <Grid 
                        ...
                        style = {{display : 'flex', justifyContent : 'center', flexDirection : 'column', paddingRight : 30}}  
                    >
                        <p style = {{textAlign:"justify"}}><b> "The goodness of man is a flame which can be hidden, but which cannot be extinguished. Yes, positive energy can never disappear without having impacted its square perimeter. "</b></p><br /><br />
                        <p style = {{textAlign:"justify"}}>The unfortunate circumstances of life and the obstacles, are not stronger than this positive energy; We are part of the perspective of contributing to a dynamic, strong, harmonious Congolese society where the fundamental and universal rights of women and vulnerable children are respected and valued, which guarantees the progress of our Congolese nation and the work it deserves.</p>
                    </Grid>
                    <Grid 
                        item
                        xs = {12}
