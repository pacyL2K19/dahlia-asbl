            ...
            <div id = 'mainContent' className = 'container' style={{marginTop : 380}}>
                ...
                <Grid container style={{pading: 80}} className="container">
                    ...
                    <Grid
                        ...
                        style={{paddingTop: 0, paddingLeft: 10, paddingRight: 10}}
                    >
                        <p style = {{fontSize: 32, fontWeight: 'bold', marginTop: 0}}>Empowerment of Congolese women through entrepreneurship</p>
                    ...
                    >
                        {/* <img src = {ecole} alt = 'image' style={{width: '100%', height: 400}} /> */}
                        <p style = {{fontSize: 32, fontWeight: 'bold', marginTop: 0}}>Farming in rural areas to fight against malnutrition</p>
                    </Grid>
                    <Grid
                        item
                        xs = {12}
