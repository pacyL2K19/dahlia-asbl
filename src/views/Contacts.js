...
const Contacts = () => {
    return (
        <div id = 'contacts'>
            <div id = 'introAbout' style = {{backgroundImage : 'url('+require('../images/bgContact.jpg')+')', backgroundPosition : 'center', backgroundSize : 'cover', backgroundRepeat : 'no-repeat', display : 'flex', justifyContent : 'center', alignItems : 'center', flexDirection : 'column'}}>
